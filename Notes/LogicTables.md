...
This table is compiled from the Fleischner Society 2017 guidelines (incidental pulmonary nodules) and is intended to reflect the *boundary conditions* used by the calculator logic.

**Assumptions encoded here (important for threshold tests):**
- Size thresholds are interpreted as: **< 6 mm**, **6–8 mm (inclusive of 6 and 8)**, and **> 8 mm** for solitary solid nodules.
- For multiple solid nodules, the split is **< 6 mm** vs **≥ 6 mm** (management based on the most suspicious nodule).
- For subsolid nodules, thresholds use **< 6 mm** vs **≥ 6 mm** (total size), and part-solid decisions also depend on **solid component < 6 mm** vs **≥ 6 mm**.
- “No routine follow-up” is treated as the lowest-intensity recommendation; “optional CT” is a higher-intensity recommendation than “none”.
